    ...
    <table class="calendar-table__inner">
      <thead class="calendar-table__head">
        <tr class="calendar-weekdays">
          <td
            class="calendar-table__cell calendar-table__cell--head"
      ...
      <tbody>
        <tr v-for="(week, index) in weeks" :key="index">
          <td
            class="calendar-table__cell calendar-table__cell--body"
          ...
          >
            ...
            <template v-if="day.day">
              ...
              <ul class="calendar-table__list" v-if="day.tasks.length > 0 && day.day">
